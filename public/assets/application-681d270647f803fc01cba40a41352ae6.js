...
(function() {
  App.module('KAKEHASHI', function(KAKEHASHI, App, Backbone, Marionette, $, _) {
    ...
    _.extend(KAKEHASHI.Controller.prototype, {
      ...
      showTarget: function(tag_type, view_mode) {
        this.trendList.fetch({
          data: {
            tag_type: tag_type
          }
        });
        return this.showMain(view_mode);
      },
      changeViewMode: function(view_mode) {
        var tag_type, url;
        url = location.href;
        tag_type = url.substring(url.lastIndexOf('#') + 1);
        return this.showTarget(tag_type, view_mode);
      }
    });
  ...
  App.module('Layout', function(Layout, App, Backbone) {
    ...
    Layout.TopBar = (function(_super) {
      ...
      TopBar.prototype.clickBubbleBtn = function() {
        console.log("click bubble btn");
        return App.KAKEHASHI.controller.changeViewMode('bubble');
      };

      TopBar.prototype.clickTableBtn = function() {
        var controller;
        console.log("click table btn");
        controller = App.KAKEHASHI.Controller();
        console.log(controller);
        return controller.changeViewMode('table');
      };
  ...
  App.module('KAKEHASHI.Views', function(Views, App, Backbone, Marionette, $) {
    Views.ItemView = (function(_super) {
      ...
      ItemView.prototype.createTooltipMsg = function() {
        var msg, name, origin, rank, total_count;
        rank = this.model.get('rank');
        name = this.model.get('name');
        origin = this.model.get('land_of_origin');
        total_count = this.model.get('total_count');
        return msg = 'No.' + rank + '</br>' + name + ' @ ' + origin + '</br><i class="fa fa-twitter fa-lg"></i>' + total_count;
      };
