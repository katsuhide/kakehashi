...
(function() {
  ...
  App.module('Layout', function(Layout, App, Backbone) {
    ...
    Layout.Main = (function(_super) {
      ...
      Main.prototype.template = 'kakehashi/apps/templates/main';
      ...
      Main.prototype.onLogoClick = function() {
        return alert("Hello KAKEHASHI!!!");
      };

      Main.prototype.onLinkClick = function() {
        return console.log("onLinkClick");
      };
  ...
  App.module('KAKEHASHI', function(KAKEHASHI, App, Backbone, Marionette, $, _) {
    ...
    _.extend(KAKEHASHI.Controller.prototype, {
      start: function() {
        ...
        return this.showMain(this.trendList);
      },
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/main"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        __out.push('<div class="off-canvas-wrap">\n  <div class="inner-wrap">\n    <nav class="tab-bar">\n      <section class="left-small">\n        <a class="left-off-canvas-toggle menu-icon" ><span></span></a>\n      </section>\n\n      <section class="middle tab-bar-section">\n        <h1 id="service-name" class="title">KAKEHASHI</h1>\n      </section>\n\n      <section class="right-small">\n        <a class="right-off-canvas-toggle menu-icon" ><span></span></a>\n      </section>\n    </nav>\n\n    <aside class="left-off-canvas-menu">\n      <ul class="off-canvas-list">\n        <li><label>Liquor</label></li>\n        <li><a href="#sake">Sake</a></li>\n        <li><a href="#shotyu">Shotyu</a></li>\n        <li><a href="#wine">Wine</a></li>\n        <li><label>Anime</label></li>\n        <li><a href="#2014-1st">2014 1-3</a></li>\n        <li><a href="#2014-2nd">2014 4-6</a></li>\n      </ul>\n    </aside>\n\n    <aside class="right-off-canvas-menu">\n      <ul class="off-canvas-list">\n        <li><label>Date</label></li>\n        <li><a href="#">1Day</a></li>\n        <li><a href="#">1Week</a></li>\n        <li><a href="#">1Month</a></li>\n        <li><a href="#">1Year</a></li>\n      </ul>\n    </aside>\n\n    <section class="main-section">\n      <!-- content goes here -->\n      ');
