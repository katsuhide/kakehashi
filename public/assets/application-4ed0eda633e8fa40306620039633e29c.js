...
(function() {
  App.module('KAKEHASHI', function(KAKEHASHI, App, Backbone, Marionette, $, _) {
    KAKEHASHI.Router = Marionette.AppRouter.extend({
      appRoutes: {
        "*target": "showTarget"
      }
    });
    KAKEHASHI.Controller = function() {
      this.period = 'week';
      this.view_mode = 'grid';
      this.tag_type = null;
      this.trendList = new App.Trends.TrendList();
      this.lastExecuteList = new App.LastExecutes.LastExecuteList();
      this.searchConditionList = new App.SearchConditions.SearchConditionList();
      return this;
    };
    _.extend(KAKEHASHI.Controller.prototype, {
      start: function() {
        this.showHeader(this.trendList);
        this.showTopBar();
        this.lastExecuteList.fetch();
        this.searchConditionList.fetch();
        this.showTrendHeader(this.lastExecuteList);
        this.showRightMenu();
        this.showFooter(this.trendList);
        return this.trendList.fetch();
      },
      showHeader: function(trendList) {
        var header;
      ...
      showTopBar: function() {
        ...
        return App.top_bar.show(top_bar);
      },
      showTrendHeader: function(lastExecuteList) {
        var trend_header;
        trend_header = new App.Layout.TrendHeader({
          collection: lastExecuteList
        });
        return App.trend_header.show(trend_header);
      },
      showRightMenu: function() {
        var right_menu;
        right_menu = new App.Layout.RightMenu;
        return App.right_menu.show(right_menu);
      },
      showFooter: function(trendList) {
        var footer;
      ...
      showMain: function() {
        ...
        return App.main.show(main);
      },
      showTarget: function(tag_type) {
        this.tag_type = tag_type;
        this.trendList.fetch({
          data: {
      ...
      fetchData: function() {
        console.log("[before:]" + this.trendList.length);
        this.trendList.fetch({
          data: {
            tag_type: "sake",
            period: this.period
        ...
        return console.log("[after:]" + this.trendList.length);
      }
    });
    return KAKEHASHI.addInitializer(function() {
      var controller;
...
(function() {
  ...
  App.module('LastExecutes', function(LastExecutes, App, Backbone) {
    LastExecutes.LastExecute = (function(_super) {
      __extends(LastExecute, _super);

      function LastExecute() {
        return LastExecute.__super__.constructor.apply(this, arguments);
      }

      return LastExecute;

    })(Backbone.Model);
    return LastExecutes.LastExecuteList = (function(_super) {
      __extends(LastExecuteList, _super);

      function LastExecuteList() {
        return LastExecuteList.__super__.constructor.apply(this, arguments);
      }

      LastExecuteList.prototype.model = LastExecutes.LastExecute;

      LastExecuteList.prototype.url = 'api/lastexecutes';
...
(function() {
  ...
  App.module('SearchConditions', function(SearchConditions, App, Backbone) {
    SearchConditions.SearchCondition = (function(_super) {
      __extends(SearchCondition, _super);

      function SearchCondition() {
        return SearchCondition.__super__.constructor.apply(this, arguments);
      }

      return SearchCondition;

    })(Backbone.Model);
    return SearchConditions.SearchConditionList = (function(_super) {
      __extends(SearchConditionList, _super);

      function SearchConditionList() {
        return SearchConditionList.__super__.constructor.apply(this, arguments);
      }

      SearchConditionList.prototype.model = SearchConditions.SearchCondition;

      SearchConditionList.prototype.url = 'api/search_conditions';

      SearchConditionList.prototype.debug = function() {
...
(function() {
  ...
  App.module('Trends', function(Trends, App, Backbone) {
    Trends.Trend = (function(_super) {
      __extends(Trend, _super);

      function Trend() {
        return Trend.__super__.constructor.apply(this, arguments);
      }

      Trend.prototype["default"] = {
        tag: 'default',
        name: 'default'
      };
    ...
    return Trends.TrendList = (function(_super) {
      __extends(TrendList, _super);

      function TrendList() {
        return TrendList.__super__.constructor.apply(this, arguments);
      }

      TrendList.prototype.model = Trends.Trend;

      TrendList.prototype.url = 'api/daytrends';

      TrendList.prototype.comparator = function(model) {
        switch (App.KAKEHASHI.controller.period) {
          case 'day':
            return model.get('day_rank');
          case 'week':
            return model.get('week_rank');
          case 'month':
            return model.get('month_rank');
          case 'total':
            return model.get('total_rank');
          default:
            return model.get('total_rank');
        }
      };
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/footer"] = function(__obj) {
    if (!__obj) __obj = {};
    ...
    (function() {
      (function() {
        __out.push('<a href="http://katz-lifehack.hatenablog.com">@Katzlifehack</a>\n');
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/header"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/main"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        ...
        __out.push('<div id="datasource-logo"><i class="fa fa-twitter fa-3x"></i></div>\n<table id="trend">\n  <thead>\n    <tr>\n      <th>Rank.</th>\n      <th>Image</th>\n      <th>Name</th>\n      <th>Count</th>\n    </tr>\n  </thead>\n  <tbody>\n    ');
      
        for (i = _i = 1; _i <= 20; i = ++_i) {
          __out.push('\n    <tr data-tooltip class="has-tip" title="This sake\'s rank is ');
          __out.push(__sanitize(i));
          __out.push('!">\n      <td>');
          __out.push(__sanitize(i));
          __out.push('</td>\n      <td><img src="assets/sake/獺祭.jpg"></td>\n      <td>獺祭 / Dassai</td>\n      <td>');
          __out.push(__sanitize(Math.floor(Math.random() * 100000)));
          __out.push(' / 10,000,000</td>\n    </tr>\n    ');
        }
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/right_menu"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        __out.push('<aside class="right-off-canvas-menu">\n\t<ul class="off-canvas-list">\n\t\t<li><label><i class="fa fa-heart fa-2x"></i> Category</label></li>\n\t\t<li><a href="#sake"> SAKE</a></li>\n\t\t<li><a href="#traditional"> JAPANESE TRADITIONAL</a></li>\n\t\t<li><a href="#anime"> ANIME</a></li>\n\t\t<li><a href="#company"> COMPANY</a></li>\n\t</ul>\n</aside>\n');
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/top_bar"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        __out.push('<nav class="tab-bar">\n\t<section class="left-small">\n\t\t<h1 id="service-name">KAKUDUKE</h1>\n\t</section>\n\n\t<section class="middle tab-bar-section">\n\t\t<nav class="top-bar" data-topbar>\n\t\t\t<section class="top-bar-section">\n\t\t\t\t<ul class="right">\n\t\t\t\t\t<li class=\'has-dropdown\'>\n\t\t\t\t\t\t<a><i class="fa fa-bar-chart-o fa-lg"></i></a>\n\t\t\t\t\t\t<ul class="dropdown">\n\t\t\t\t\t\t\t<li class="view-mode" id="bubble_btn"><a>Bubble View<i class="fa fa-check-circle-o fa-lg"></i></a></li>\n\t\t\t\t\t\t\t<li class="view-mode" id="table_btn"><a>Table View<i class="fa fa-check-circle-o fa-lg"></i></a></li>\n\t\t\t\t\t\t\t<li class="view-mode" id="grid_btn"><a>Grid View<i class="fa fa-check-circle-o fa-lg"></i></a></li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</li>\n\t\t\t\t\t<li class=\'has-dropdown\'>\n\t\t\t\t\t\t<a><i class="fa fa-calendar fa-lg"></i></a>\n\t\t\t\t\t\t<ul class="dropdown">\n\t\t\t\t\t\t\t<li class="period" id="day_btn"><a>Today<i class="fa fa-check-circle-o fa-lg"></i></a></li>\n\t\t\t\t\t\t\t<li class="period" id="week_btn"><a>This Week<i class="fa fa-check-circle-o fa-lg"></i></a></li>\n\t\t\t\t\t\t\t<li class="period" id="month_btn"><a>This Month<i class="fa fa-check-circle-o fa-lg"></i></a></li>\n\t\t\t\t\t\t\t<li class="period" id="all_btn"><a>All<i class="fa fa-check-circle-o fa-lg"></i></a></li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</li>\n\t\t\t\t</ul>\n\t\t\t</section>\n\t\t</nav>\n\t</section>\n\n\t<section class="right-small">\n\t\t<a class="right-off-canvas-toggle"><i class="fa fa-heart"></i> <i class="fa fa-angle-double-right"></i></a>\n\t</section>\n</nav><!-- tab-bar end -->\n');
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trend"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        ...
        image_url_full = this.getImageURL(this);
      
        __out.push('\n<td>');
      
        __out.push(__sanitize(this.getRank(this)));
      
        __out.push('</td>\n<td><img src=');
      
        __out.push(__sanitize(image_url_full));
        ...
        if (this.doesDisplayLandOfOrigin()) {
          __out.push('\n<td>');
          __out.push(__sanitize(this['land_of_origin']));
          __out.push('</td>\n');
        }
      
        __out.push('\n<td><i class="fa fa-twitter fa-lg"></i>');
      
        __out.push(__sanitize(this.getCount(this)));
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trend_bubble"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        var image_url_full, rank;
      
        image_url_full = this.getImageURL(this);
      
        __out.push('\n<div id="trend">\n\t');
      
        rank = this.getRank(this);
        ...
        if (rank <= 1) {
          __out.push('\n\t<img src=');
          __out.push(__sanitize(image_url_full));
          __out.push(' class="box size99" id="bubble-');
          __out.push(__sanitize(this['keyword_id']));
          __out.push('">\n\t');
        } else if (rank <= 5) {
          __out.push('\n\t<img src=');
          __out.push(__sanitize(image_url_full));
          __out.push(' class="box size66" id="bubble-');
          __out.push(__sanitize(this['keyword_id']));
          __out.push('">\n\t');
        } else if (rank <= 10) {
          __out.push('\n\t<img src=');
          __out.push(__sanitize(image_url_full));
          __out.push(' class="box size44" id="bubble-');
          __out.push(__sanitize(this['keyword_id']));
          __out.push('">\n\t');
        } else if (rank <= 30) {
          __out.push('\n\t<img src=');
          __out.push(__sanitize(image_url_full));
          __out.push(' class="box size33" id="bubble-');
          __out.push(__sanitize(this['keyword_id']));
          __out.push('">\n\t');
        } else {
          __out.push('\n\t<img src=');
          __out.push(__sanitize(image_url_full));
          __out.push(' class="box size22" id="bubble-');
          __out.push(__sanitize(this['keyword_id']));
          __out.push('">\n\t');
        }
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trend_grid"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trend_header"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        __out.push('<div id="datasource-logo">\n\t<i class="fa fa-twitter fa-3x"></i>\n</div>\n');
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trends"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        ...
        __out.push('<div class="small-8 columns">\n  <table id="trend-table">\n    <thead>\n<!--     <tr>\n      <th>Rank.</th>\n      <th></th>\n      <th>名称</th>\n      ');
      
        __out.push('\n      <th>原産地</th>\n      ');
      
        __out.push('\n      <th>Tweet Hit数</th>\n    </tr>\n  -->  </thead>\n  <tbody id="trend-list"></tbody>\n</table>\n</div>\n<div class="small-4 columns">\n  ');
      
        tag_type = this.getCategory();
      
        __out.push('\n  ');
      
        if (tag_type === 'sake' || (tag_type == null)) {
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trends_bubble"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trends_grid"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        __out.push('<div id="trend-list"></div>\n');
...
(function() {
  ...
  App.module('Layout', function(Layout, App, Backbone, Marionette, $, _) {
    Layout.Header = (function(_super) {
      ...
      Header.prototype.template = 'kakehashi/apps/templates/header';
    ...
    Layout.TopBar = (function(_super) {
      ...
      TopBar.prototype.template = 'kakehashi/apps/templates/top_bar';
      ...
      TopBar.prototype.onShow = function() {
        $(document).foundation();
        this.toggleViewModeBtn();
        return this.togglePeriodBtn();
      };

      TopBar.prototype.toggleViewModeBtn = function() {
        var view_mode;
        this.ui.view_mode.addClass('not-selected');
        view_mode = App.KAKEHASHI.controller.view_mode;
        switch (view_mode) {
          case 'bubble':
            return this.ui.bubble_btn.removeClass('not-selected');
          case 'table':
            return this.ui.table_btn.removeClass('not-selected');
          case 'grid':
            return this.ui.grid_btn.removeClass('not-selected');
        }
      };

      TopBar.prototype.togglePeriodBtn = function() {
        var period;
        this.ui.period.addClass('not-selected');
        period = App.KAKEHASHI.controller.period;
        switch (period) {
          case 'day':
            this.ui.day_btn.removeClass('not-selected');
            break;
          case 'week':
            this.ui.week_btn.removeClass('not-selected');
            break;
          case 'month':
            this.ui.month_btn.removeClass('not-selected');
            break;
          case 'all':
            this.ui.all_btn.removeClass('not-selected');
            break;
          default:
            this.ui.week_btn.removeClass('not-selected');
        }
        return App.KAKEHASHI.controller.showMain();
      };

      TopBar.prototype.clickBubbleBtn = function() {
        App.KAKEHASHI.controller.view_mode = 'bubble';
        this.toggleViewModeBtn();
        return App.KAKEHASHI.controller.showMain();
      };

      TopBar.prototype.clickTableBtn = function() {
        App.KAKEHASHI.controller.view_mode = 'table';
        this.toggleViewModeBtn();
        return App.KAKEHASHI.controller.showMain();
      };

      TopBar.prototype.clickGridBtn = function() {
        App.KAKEHASHI.controller.view_mode = 'grid';
        this.toggleViewModeBtn();
        return App.KAKEHASHI.controller.showMain();
      };

      TopBar.prototype.clickDayBtn = function() {
        App.KAKEHASHI.controller.period = 'day';
        return this.togglePeriodBtn();
      };

      TopBar.prototype.clickWeekBtn = function() {
        App.KAKEHASHI.controller.period = 'week';
        return this.togglePeriodBtn();
      };

      TopBar.prototype.clickMonthBtn = function() {
        App.KAKEHASHI.controller.period = 'month';
        return this.togglePeriodBtn();
      };

      TopBar.prototype.clickAllBtn = function() {
    ...
    Layout.TrendHeader = (function(_super) {
      __extends(TrendHeader, _super);

      function TrendHeader() {
        return TrendHeader.__super__.constructor.apply(this, arguments);
      }

      TrendHeader.prototype.template = 'kakehashi/apps/templates/trend_header';

      TrendHeader.prototype.events = {
        'click #datasource-logo': 'clickLogo'
      };

      TrendHeader.prototype.onShow = function() {
        return $(document).foundation();
      };

      TrendHeader.prototype.clickLogo = function() {
        console.log("click logo");
        return App.main.destroy();
      };

      return TrendHeader;

    })(Backbone.Marionette.ItemView);
    Layout.RightMenu = (function(_super) {
      __extends(RightMenu, _super);

      function RightMenu() {
        return RightMenu.__super__.constructor.apply(this, arguments);
      }

      RightMenu.prototype.template = 'kakehashi/apps/templates/right_menu';

      RightMenu.prototype.onShow = function() {
        return $(document).foundation();
      };
    ...
    return Layout.Footer = (function(_super) {
      ...
      Footer.prototype.template = 'kakehashi/apps/templates/footer';

      Footer.prototype.onShow = function() {};
...
(function() {
  ...
  App.module('KAKEHASHI.Views', function(Views, App, Backbone, Marionette, $) {
    Views.ItemView = (function(_super) {
      ...
      ItemView.prototype.template = 'kakehashi/apps/templates/trend_grid';
      ...
      ItemView.prototype.modelRemove = function() {
        return console.log("modelRemove");
      };

      ItemView.prototype.modelChange = function() {
        return console.log("modelChange");
      };

      ItemView.prototype.modelAdd = function() {
        return console.log("modelAdd");
      };

      ItemView.prototype.onDestroy = function() {
        return console.log("destroy the item view");
      };

      ItemView.prototype.onRender = function() {};

      ItemView.prototype.onShow = function() {
        return this.appendIsotope();
      };

      ItemView.prototype.appendIsotope = function() {
        return $('#trend-list').isotope('appended', this.$el);
      };

      ItemView.prototype.initTooltip = function() {
        return $("#bubble-" + (this.model.get('keyword_id'))).tooltipster({
          content: $('<span><strong>' + this.createTooltipMsg() + '</strong></span>')
        });
      };

      ItemView.prototype.initIsotope = function() {
        return $('#trend-list').isotope({
      ...
      ItemView.prototype.dblclickBubble = function() {
        console.log("dblclickBubble");
        return window.open("https://twitter.com/intent/tweet?button_hashtag=tag_name&text=messages");
      };

      ItemView.prototype.getCount = function() {
        var count;
        switch (App.KAKEHASHI.controller.period) {
          case 'day':
            return count = this.model.get('day_count');
          case 'week':
            return count = this.model.get('week_count');
          case 'month':
            return count = this.model.get('month_count');
          case 'all':
            return count = this.model.get('total_count');
          default:
            return count = this.model.get('total_count');
        }
      };

      ItemView.prototype.getRank = function() {
        var rank;
        switch (App.KAKEHASHI.controller.period) {
          case 'day':
            return rank = this.model.get('day_rank');
          case 'week':
            return rank = this.model.get('week_rank');
          case 'month':
            return rank = this.model.get('month_rank');
          case 'all':
            return rank = this.model.get('total_rank');
          default:
            return rank = this.model.get('total_rank');
        }
      };

      ItemView.prototype.createTooltipMsg = function() {
        var count, msg, name, origin, rank, tag_type;
        tag_type = this.model.get('tag_type');
        rank = this.getRank();
        name = this.model.get('name');
        origin = this.model.get('land_of_origin');
        count = this.getCount();
        msg = 'No.' + rank + '</br>';
        switch (tag_type) {
          case 'sake':
        ...
        return msg += '<i class="fa fa-twitter fa-lg"></i>' + count + '</br>';
      };

      ItemView.prototype.templateHelpers = {
        getImageURL: function(model) {
          var image_url_full;
          return image_url_full = "assets/" + model['tag_type'] + "/" + model['image_url'];
        },
        getRank: function(model) {
          var rank;
          switch (App.KAKEHASHI.controller.period) {
            case 'day':
              return rank = model['day_rank'];
            case 'week':
              return rank = model['week_rank'];
            case 'month':
              return rank = model['month_rank'];
            case 'all':
              return rank = model['total_rank'];
            default:
              return rank = model['total_rank'];
          }
        }
    ...
    return Views.GridListView = (function(_super) {
      __extends(GridListView, _super);

      function GridListView() {
        return GridListView.__super__.constructor.apply(this, arguments);
      }

      GridListView.prototype.template = 'kakehashi/apps/templates/trends_grid';

      GridListView.prototype.itemView = Views.ItemView;

      GridListView.prototype.itemViewContainer = '#trend-list';

      GridListView.prototype.collectionEvents = {
        'change': 'collectionChange',
        'add': 'collectionAdd'
      };

      GridListView.prototype.collectionChange = function() {
        return console.log("collectionChange");
      };

      GridListView.prototype.collectionAdd = function() {
        return console.log("collectionAdd");
      };

      GridListView.prototype.onShow = function() {
      ...
      GridListView.prototype.initIsotope = function() {
      ...
      GridListView.prototype.onHoge = function() {
        return "hoge";
      };

      GridListView.prototype.templateHelpers = {
        getCategory: function() {
          return App.KAKEHASHI.controller.tag_type;
        }
      };
...
(function() {
  ...
  App.module('KAKEHASHI.Views', function(Views, App, Backbone, Marionette, $) {
    Views.ItemView = (function(_super) {
      ...
      ItemView.prototype.template = 'kakehashi/apps/templates/trend';
      ...
      ItemView.prototype.templateHelpers = {
        ...
        getCount: function(model) {
          ...
          switch (App.KAKEHASHI.controller.period) {
            case 'day':
              return count = model['day_count'];
            case 'week':
              return count = model['week_count'];
            case 'month':
              return count = model['month_count'];
            case 'all':
              return count = model['total_count'];
            default:
              return count = model['total_count'];
          }
        },
        ...
        doesDisplayLandOfOrigin: function() {
          var tag_type;
    ...
    return Views.TableListView = (function(_super) {
      ...
      TableListView.prototype.template = 'kakehashi/apps/templates/trends';

      TableListView.prototype.itemView = Views.ItemView;

      TableListView.prototype.itemViewContainer = '#trend-list';

      TableListView.prototype.onShow = function() {
        if (typeof twttr !== "undefined" && twttr !== null) {
          return twttr.widgets.load();
        }
      };

      TableListView.prototype.templateHelpers = {
        doesDisplayLandOfOrigin: function() {
          var tag_type;
          tag_type = App.KAKEHASHI.controller.tag_type;
          switch (tag_type) {
...
(function() {
  ...
  App.module('KAKEHASHI.Views', function(Views, App, Backbone, Marionette, $) {
    Views.ItemView = (function(_super) {
      ...
      ItemView.prototype.template = 'kakehashi/apps/templates/trend_bubble';
      ...
      ItemView.prototype.createTooltipMsg = function() {
        var count, msg, name, origin, rank, tag_type, twitter_btn;
        tag_type = this.model.get('tag_type');
        rank = this.getRank();
        name = this.model.get('name');
        origin = this.model.get('land_of_origin');
    ...
    return Views.ListView = (function(_super) {
      ...
      ListView.prototype.template = 'kakehashi/apps/templates/trends_bubble';

      ListView.prototype.itemView = Views.ItemView;

      ListView.prototype.itemViewContainer = '#trend-list';
      ...
      ListView.prototype.templateHelpers = {
        getCategory: function() {
          return App.KAKEHASHI.controller.tag_type;
        }
      };
