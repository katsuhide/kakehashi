...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trend_bubble"] = function(__obj) {
    ...
    (function() {
      (function() {
        __out.push('<div id="hoge"><img src="assets/sake/');
...
(function() {
  ...
  App.module('KAKEHASHI.Views', function(Views, App, Backbone, Marionette, $) {
    Views.ItemView = (function(_super) {
      ...
      ItemView.prototype.tagName = 'div class="box size11"';
      ...
      ItemView.prototype.onShow = function() {
        ...
        box = makeBoxes2();
        return $("#trend-list").append(box).nested('append', box);
      };

      ItemView.prototype.hogeFunction = function() {
        console.log("Hoge is hoge!");
        return $("#trend-list").nested({
          selector: '.box'
        });
      };
    ...
    return Views.ListView = (function(_super) {
      ...
      ListView.prototype.onShow = function() {
        return console.log("trend listview onShow");
      };
