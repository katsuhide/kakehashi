    ...
    _.extend(KAKEHASHI.Controller.prototype, {
      ...
      showMain: function() {
        ...
        switch (this.view_mode) {
          case 'bubble':
            return App.main.show(new KAKEHASHI.Views.ListView({
              collection: this.trendList
            }));
          case 'table':
            return App.main.show(new KAKEHASHI.Views.TableListView({
              collection: this.trendList
            }));
          case 'grid':
            return App.main.show(new KAKEHASHI.Views.GridListView({
              collection: this.trendList
            }));
          default:
            return App.main.show(new KAKEHASHI.Views.GridListView({
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trend_header"] = function(__obj) {
    ...
    (function() {
      (function() {
        __out.push('<a href="https://twitter.com/intent/tweet?button_hashtag=tag_name&text=messages" class="twitter-hashtag-button" data-lang="en">Tweet #tag_name</a>\n<div id="datasource-logo">\n\t<i class="fa fa-twitter fa-3x"></i>\n</div>\n');
  ...
  App.module('Layout', function(Layout, App, Backbone, Marionette, $, _) {
    ...
    Layout.TrendHeader = (function(_super) {
      ...
      TrendHeader.prototype.clickLogo = function() {
        console.log(this.collection.models[0].get('executed_time'));
        return console.log(App.KAKEHASHI.controller.searchConditionList.debug());
      };
