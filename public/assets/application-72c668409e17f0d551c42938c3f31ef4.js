...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trend"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        __out.push(__sanitize(this['rank']));
  ...
  App.module('Layout', function(Layout, App, Backbone, Marionette, $, _) {
    ...
    Layout.TrendHeader = (function(_super) {
      ...
      TrendHeader.prototype.clickLogo = function() {
        ...
        return console.log(App.KAKEHASHI.controller.view_mode);
      };
...
(function() {
  ...
  App.module('KAKEHASHI.Views', function(Views, App, Backbone, Marionette, $) {
    Views.ItemView = (function(_super) {
      ...
      ItemView.prototype.clickTrend = function() {
        return console.log("click trend");
      };
      ...
      ItemView.prototype.templateHelpers = {
        ...
        getTooltipMsg: function() {
          return this.createTooltipMsg2();
        },
        createTooltipMsg2: function() {
          console.log("createTooltipMsg2");
          return "No." + this['rank'] + "-" + this['name'] + "@" + this['land_of_origin'] + ":" + this['total_count'];
        }
      };
