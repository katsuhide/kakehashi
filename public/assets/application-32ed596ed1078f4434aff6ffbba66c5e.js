...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trend_bubble"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        __out.push('<div id="trend">\n\t<span data-tooltip class="has-tip [tip-bottom tip-right] [radius round] " title=');
      
        __out.push(__sanitize(this.getTooltipMsg()));
        ...
        if (rank <= 1) {
          __out.push('\n\t\t\t<img src="assets/sake/');
          __out.push(__sanitize(this['tag']));
          __out.push('.jpg" class="box size99">\n\t\t');
        } else if (rank <= 5) {
          __out.push('\n\t\t\t<img src="assets/sake/');
          __out.push(__sanitize(this['tag']));
          __out.push('.jpg" class="box size77">\n\t\t');
        } else if (rank <= 10) {
          __out.push('\n\t\t\t<img src="assets/sake/');
          __out.push(__sanitize(this['tag']));
          __out.push('.jpg" class="box size44">\n\t\t');
        } else if (rank <= 30) {
          __out.push('\n\t\t\t<img src="assets/sake/');
          __out.push(__sanitize(this['tag']));
          __out.push('.jpg" class="box size33">\n\t\t');
        } else {
          __out.push('\n\t\t\t<img src="assets/sake/');
          __out.push(__sanitize(this['tag']));
          __out.push('.jpg" class="box size22">\n\t\t');
        }
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trends_bubble"] = function(__obj) {
    ...
    (function() {
      (function() {
        __out.push('<div id="datasource-logo">\n\t<span data-tooltip class="has-tip" title="Tooltips Test! \\n Twitter !!">\n\t\t<i class="fa fa-twitter fa-3x"></i>\n\t</span>\n</div>\n<div id="trend-list">\n</div>\n');
...
(function() {
  ...
  App.module('Layout', function(Layout, App, Backbone) {
    ...
    return Layout.Footer = (function(_super) {
      ...
      Footer.prototype.completedCount = function(total) {
        return {
          totalCount: total
        };
      };

      Footer.prototype.getTotalCount = function() {
        return this.collection.length;
      };

      Footer.prototype.templateHelpers = {
        countList: function() {
          return console.log("footer:" + this.getTotalCount);
        }
      };
  ...
  App.module('KAKEHASHI.Views', function(Views, App, Backbone, Marionette, $) {
    Views.ItemView = (function(_super) {
      ...
      ItemView.prototype.trendFunction = function() {
        return console.log("hogeFunction");
      };

      ItemView.prototype.templateHelpers = {
        getTooltipMsg: function() {
          return this.createTooltipMsg();
        },
