...
(function() {
  App.module('KAKEHASHI', function(KAKEHASHI, App, Backbone, Marionette, $, _) {
    ...
    _.extend(KAKEHASHI.Controller.prototype, {
      ...
      showMain: function(trendList, target) {
        switch (target) {
          case 'table':
      ...
      showTarget: function(target) {
        ...
        return this.showMain(this.trendList, target);
      }
    });
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trend"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        __out.push('</td>\n<td><img src="assets/sake/');
      
        __out.push(__sanitize(this['tag']));
    ...
    (function() {
      (function() {
        ...
        if (rank <= 1) {
          __out.push('\n\t\t<img src="assets/sake/');
          __out.push(__sanitize(this['tag']));
          __out.push('.jpg" class="box size99" id="bubble-');
          __out.push(__sanitize(this['rank']));
          __out.push('">\n\t\t');
        } else if (rank <= 5) {
          __out.push('\n\t\t<img src="assets/sake/');
          __out.push(__sanitize(this['tag']));
          __out.push('.jpg" class="box size77" id="bubble-');
          __out.push(__sanitize(this['rank']));
          __out.push('">\n\t\t');
        } else if (rank <= 10) {
          __out.push('\n\t\t<img src="assets/sake/');
          __out.push(__sanitize(this['tag']));
          __out.push('.jpg" class="box size44" id="bubble-');
          __out.push(__sanitize(this['rank']));
          __out.push('">\n\t\t');
        } else if (rank <= 30) {
          __out.push('\n\t\t<img src="assets/sake/');
          __out.push(__sanitize(this['tag']));
          __out.push('.jpg" class="box size33" id="bubble-');
          __out.push(__sanitize(this['rank']));
          __out.push('">\n\t\t');
        } else {
          __out.push('\n\t\t<img src="assets/sake/');
          __out.push(__sanitize(this['tag']));
          __out.push('.jpg" class="box size22" id="bubble-');
          __out.push(__sanitize(this['rank']));
          __out.push('">\n\t\t');
        }
...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/trend_header"] = function(__obj) {
    ...
    (function() {
      (function() {
        __out.push('<div class="small-4 columns">\n\t<p></p>\n</div>\n<div id="datasource-logo" class="small-4 columns">\n\t<i class="fa fa-twitter fa-3x"></i>\n</div>\n<div class="small-4 columns">\n\t<a href="#" data-dropdown="view-mode-btn" class="button dropdown" data-options="is_hover:true">View Mode</a><br>\n\t<ul id="view-mode-btn" data-dropdown-content class="f-dropdown">\n\t\t<li id="bubble_btn">Bubble View</li>\n\t\t<li id="table_btn">Table View</li>\n\t</ul>\n</div>\n');
...
(function() {
  ...
  App.module('Layout', function(Layout, App, Backbone) {
    ...
    Layout.TrendHeader = (function(_super) {
      ...
      TrendHeader.prototype.clickBubbleBtn = function() {
        var controller;
        controller = new App.KAKEHASHI.Controller();
        return controller.showTarget('bubble');
      };

      TrendHeader.prototype.clickTableBtn = function() {
        var controller;
        controller = new App.KAKEHASHI.Controller();
        return controller.showTarget('table');
      };
  ...
  App.module('KAKEHASHI.Views', function(Views, App, Backbone, Marionette, $) {
    Views.ItemView = (function(_super) {
      ...
      ItemView.prototype.onShow = function() {
        $("#trend-list").nested('append', this);
        return this.initTooltip();
      };

      ItemView.prototype.trendFunction = function() {
        return console.log("trendFunction");
      };
