...
(function() { this.JST || (this.JST = {}); this.JST["kakehashi/apps/templates/footer"] = function(__obj) {
    ...
    (function() {
      (function() {
        __out.push('<span data-tooltip class="has-tip" title="Tooltips are awesome, you should totally use them!">\n\t<a href="http://katz-lifehack.hatenablog.com">@Katzlifehack</a>\n</span>\n');
